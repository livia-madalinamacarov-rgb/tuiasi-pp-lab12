...
object TransformUtils {
    ...
    fun applyTransform(map: HashMap<String, Int>, transform: Transform<Int>): HashMap<String, Int> {
        // Folosim mapValues pentru transformare și convertim rezultatul înapoi la tipul HashMap cerut de semnătură
        val transformedMap = map.mapValues { transform(it.value) }
        return HashMap(transformedMap)
    }
}